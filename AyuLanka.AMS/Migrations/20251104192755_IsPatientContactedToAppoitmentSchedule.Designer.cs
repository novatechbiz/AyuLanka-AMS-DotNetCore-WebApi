...
namespace AyuLanka.AMS.Migrations
{
    ...
    [Migration("20251104192755_IsPatientContactedToAppoitmentSchedule")]
    partial class IsPatientContactedToAppoitmentSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AyuLanka.AMS.DataModels.AppointmentSchedule", b =>
                {
                    ...
                    b.Property<TimeSpan?>("ActualFromTime")
                        .HasColumnType("time");

                    b.Property<TimeSpan?>("ActualFromTimeSecond")
                        .HasColumnType("time");

                    b.Property<TimeSpan?>("ActualToTime")
                        .HasColumnType("time");
                    ...
                    b.Property<bool?>("IsNeededToFollowUp")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsPatientContacted")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("ParentAppointmentScheduleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParentAppointmentScheduleId");
            ...
            modelBuilder.Entity("AyuLanka.AMS.DataModels.LocationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AyuLanka.AMS.DataModels.TreatmentType", b =>
                {
                    ...
                    b.Property<string>("TreatmentShortCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AyuLanka.AMS.DataModels.AppointmentSchedule", b =>
                {
                    b.HasOne("AyuLanka.AMS.DataModels.Employee", "DeletedByEmployee")
                        .WithMany()
                        .HasForeignKey("DeletedBy");

                    b.HasOne("AyuLanka.AMS.DataModels.Employee", "DoctorEmployee")
                        .WithMany()
                    ...
                    b.HasOne("AyuLanka.AMS.DataModels.Employee", "EnteredByEmployee")
                        .WithMany()
                    ...
                    b.HasOne("AyuLanka.AMS.DataModels.AppointmentSchedule", "ParentAppointmentSchedule")
                        .WithMany("ChildAppointments")
                        .HasForeignKey("ParentAppointmentScheduleId");

                    b.HasOne("AyuLanka.AMS.DataModels.Employee", "SecondaryEmployee")
                        .WithMany()
                        .HasForeignKey("SecondaryEmployeeId");

                    b.HasOne("AyuLanka.AMS.DataModels.Employee", "UpdatedByEmployee")
                        .WithMany()
                        .HasForeignKey("UpdatedBy");

                    b.Navigation("DeletedByEmployee");

                    b.Navigation("DoctorEmployee");
                    ...
                    b.Navigation("ParentAppointmentSchedule");
            ...
            modelBuilder.Entity("AyuLanka.AMS.DataModels.Location", b =>
                {
                    b.HasOne("AyuLanka.AMS.DataModels.LocationType", "LocationType")
                        .WithMany("Locations")
